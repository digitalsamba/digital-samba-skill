...
- `local_mute_enabled` room setting in api-reference.md — lets participants mute anyone just for themselves, or isolate a single speaker, without affecting what the rest of the room hears or anyone's actual microphone
